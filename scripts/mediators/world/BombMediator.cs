...
public class BombMediator : MonoBehaviour {
	...
	void Awake()
	{
		Messenger.AddListener("activatebombs", ActivateBombEventHandler);
	}
	
	void OnDestroy()
	{
		Messenger.RemoveListener("activatebombs", ActivateBombEventHandler);
	}
